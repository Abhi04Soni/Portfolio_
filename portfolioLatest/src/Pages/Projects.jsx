...
export default function Projects() {
  return (
      ...
      <a href="https://react00chat00app.netlify.app/" target='_blank'><ProjectCard src={chatappImg} title={"React Realtime messaging app"} desc={"A unique way to chat"} /></a>
      <a href="https://ornate-starship-e90145.netlify.app/" target='_blank'><ProjectCard src={notesImg} title = {"Notes App"} desc={"A unique way to take notes"} /></a>
